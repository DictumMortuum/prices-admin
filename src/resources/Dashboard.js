  ...
  return (
    <Container title="Dashboard">
      <Stack p={4}>
        ...
        <Typography mt={3}>
          Δυστυχώς ο αριθμός των update που γίνονται καθημερινά στους τίτλους είναι αρκετά, τα οποία ορίζονται ως αλλαγή στη διαθεσιμότητα ή στην τιμή. Για αυτόν τον λόγο, ο καλύτερος τρόπος να χρησιμοποιήσετε το site είναι να κάνετε αναζήτηση.
        </Typography>
        <Typography>
